...
| Projeto | Demanda, proposta, eixo, plano de trabalho, equipe, etapa, atividade, entrega e resultado. | ⚠️ Parcial — `DemandaProjeto` e `Projeto` implementados (demanda/proposta, eixo, portfólio, informações básicas do plano de trabalho); equipe, etapa, atividade, entrega e resultado ainda não têm modelo próprio |
